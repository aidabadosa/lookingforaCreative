...
art_user = User.create(email: "loliart@gmail.com", password: "loliart22", profile_id: art.id, name: 'Loli Art')
coder_user = User.create(email: "lolocoder@gmail.com", password: "lolocoder22", profile_id: coder.id, name: 'Lolo coder')
copy_user = User.create(email: "aidacopy@gmail.com", password: "aidacopy22", profile_id: copy.id, name: 'Aida Copy')
